...
export type Query = {
  ...
  testEncryptGenerateTemporaryPassword: TestingEncryptionGenerateTemporaryPassword;
  /** Generates a unique token */
  testEncryptGenerateUniqueToken: TestingEncryptionGenerateUniqueToken;
  /** Hashes a password */
  testEncryptHashPassword: TestingEncryptionHashPassword;
  /** Verifies a password */
  testEncryptVerifyPassword: TestingEncryptionVerifyPassword;
  user: User;
...
export type QueryTestEncryptGenerateTemporaryPasswordArgs = {
  length?: InputMaybe<Scalars['Float']['input']>;
};


export type QueryTestEncryptGenerateUniqueTokenArgs = {
  length?: InputMaybe<Scalars['Float']['input']>;
};


export type QueryTestEncryptHashPasswordArgs = {
  rawPassword: Scalars['String']['input'];
};


export type QueryTestEncryptVerifyPasswordArgs = {
...
export type SystemInfoMemory = {
  __typename?: 'SystemInfoMemory';
  /** Free memory in bytes */
  freemem: Scalars['Float']['output'];
  /** Heap total memory in bytes */
  heapTotal: Scalars['Float']['output'];
  /** Total memory in bytes */
  totalmem: Scalars['Float']['output'];
};

/** Process Information Model */
export type SystemInfoProcess = {
  __typename?: 'SystemInfoProcess';
  /** Process Uptime */
  uptime: Scalars['Float']['output'];
};

/** Runtime Information Model */
export type SystemInfoRuntime = {
  __typename?: 'SystemInfoRuntime';
  /** Node environment */
  nodeEnv: Scalars['String']['output'];
};

/** Represents the result of a temporary password generation attempt */
export type TestingEncryptionGenerateTemporaryPassword = {
  __typename?: 'TestingEncryptionGenerateTemporaryPassword';
  /** The generated temporary password */
  temporaryPassword: Scalars['String']['output'];
};

/** Represents the result of a unique token generation attempt */
export type TestingEncryptionGenerateUniqueToken = {
  __typename?: 'TestingEncryptionGenerateUniqueToken';
  /** The generated unique token */
  uniqueToken: Scalars['String']['output'];
};

/** Represents a hashed password */
export type TestingEncryptionHashPassword = {
  __typename?: 'TestingEncryptionHashPassword';
  /** The hashed password */
  hashedPassword?: Maybe<Scalars['String']['output']>;
  /** The raw password before hashing */
  rawPassword: Scalars['String']['output'];
};

/** Represents the result of a password verification attempt */
export type TestingEncryptionVerifyPassword = {
  __typename?: 'TestingEncryptionVerifyPassword';
  /** The hashed password to compare against */
  hashedPassword?: Maybe<Scalars['String']['output']>;
  /** Indicates if the password verification was successful */
...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'Login', accessToken: string, user: { __typename?: 'User', id: string, username: string } } };
